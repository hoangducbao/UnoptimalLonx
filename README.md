...
5. **Run the app and tunnel to your browser**:
   ...
   Prefix `R101_EMBED=1152` (or `R101_EMBED=1536`) to run one of the other profiles instead.
   Attach the matching `1152embed/` or `1536embed/` folders to your dataset first, and expect the longer first boot -- a
   ~4.2 GB or ~7 GB model download plus a from-scratch FAISS build, every session, since Kaggle sessions are ephemeral.
